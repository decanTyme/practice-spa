...
import { modifyStock } from "../../../../../../app/state/slices/data/product";
import {
  moveStock,
  removeStock,
...
function StockMenu({ variant, type, stockList }) {
          ...
          <ModalMenu.Content>
            ...
            <ModalMenu.Body>
              <div style={{ fontSize: "0.925rem" }}>
                {stockList[type] && stockList[type].length !== 0 ? (
                  stockList[type].map((stock, i) => (
                    <Card
                      key={stock.batch}
